...
char input_real_data[] = "../Data_sets/PCOA_7965_species_coords_dim_20.csv",
      output_precision_artificial_data[] = "Output/MPD_WSPD_artificial_data_precision_variable_n.txt",
      output_time_artificial_data[] = "Output/MPD_WSPD_artificial_data_time_variable_n.txt",
      output_precision_real_data[] = "Output/MPD_WSPD_real_data_precision_variable_n.txt",
      output_time_real_data[] = "Output/MPD_WSPD_real_data_time_variable_n.txt";
...
int main(int argc, char *argv[])
{
  ...
  if(conduct_experiments_on_artificial_data == true)
  {
    ...
    for(int n=minimum_n_artificial_data; n<=maximum_n_artificial_data; n+=step )
    {
      ...
      expectation_approx = mpd_approx.compute_expectation(s);
      variance_approx = mpd_approx.compute_variance(s);
